    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Link to="/admin/users" className="apple-glass rounded-xl p-6 hover:bg-white/5 transition-colors group">
                ...
                <Link to="/admin/subscriptions" className="apple-glass rounded-xl p-6 hover:bg-white/5 transition-colors group">
                    <div className="flex items-center gap-3">
                ...
                <Link to="/admin/system" className="apple-glass rounded-xl p-6 hover:bg-white/5 transition-colors group">
                    <div className="flex items-center gap-3">
