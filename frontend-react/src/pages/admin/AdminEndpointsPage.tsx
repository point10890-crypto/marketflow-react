    ...
    return (
        <section className="rounded-xl border border-white/10 bg-[#10151f]/90 p-3 shadow-[0_18px_70px_rgba(0,0,0,0.22)] backdrop-blur sm:p-4">
            <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between lg:gap-4">
                ...
                <div style={{ scrollbarWidth: 'none' }} className="mobile-dashboard-rail-scroll -mx-3 flex snap-x snap-mandatory flex-nowrap items-center gap-2 overflow-x-auto px-3 pb-1 [&>*]:shrink-0 [&>*]:snap-start sm:mx-0 sm:flex-wrap sm:overflow-visible sm:px-0 sm:pb-0">
        ...
        <div className="space-y-4 pb-24 md:space-y-5 md:pb-0">
            <section className={`border-b ${
                ...
                <div className="px-3 py-4 sm:px-5 sm:py-7 md:px-8 md:py-10">
                    ...
                    <div className={subscriberMode ? 'mt-4 grid min-w-0 gap-4 xl:grid-cols-[minmax(260px,0.6fr)_minmax(0,1fr)_minmax(0,1fr)] xl:items-stretch' : 'mt-4 max-w-4xl'}>
