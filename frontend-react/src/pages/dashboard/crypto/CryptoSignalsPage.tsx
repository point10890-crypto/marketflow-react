            ...
            <div className="flex items-end justify-between shrink-0">
                <div>
                    <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-[10px] font-semibold text-amber-400 uppercase tracking-widest">CRYPTO VCP SIGNALS</span>
                    </div>
                    <h2 className="text-2xl font-extrabold tracking-tight text-white">
                        Crypto{' '}
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-300 to-amber-500">VCP</span>
                    </h2>
                    <p className="text-xs text-gray-500 mt-1">Minervini SEPA — Crypto Market Screening</p>
                </div>
                <div className="flex items-center gap-3">
                    ...
                    <select
                        ...
                        className="text-[11px] bg-[#13151f] border border-white/10 rounded-lg px-3 py-1.5 text-gray-300 focus:outline-none focus:border-amber-500/50"
                    >
            ...
            <div className="flex-1 overflow-y-auto min-h-0 space-y-2">
                ...
                {!loading && !error && signals.length === 0 && (
                    <div className="text-center py-20 text-gray-500">
                        ...
                        <p className="text-sm">No VCP signals detected for Crypto Market</p>
                    </div>
                )}
