            ...
            <div className="dash-page-header market-page-header flex flex-wrap items-end justify-between gap-4 shrink-0">
                <div>
                    <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="market-identity">CRYPTO VCP SIGNALS</span>
                    </div>
                    <h2 className="market-title">
                        Crypto{' '}
                        <span className="market-title-accent">VCP</span>
                    </h2>
                    <p className="text-xs text-gray-400 mt-1">Minervini SEPA · Crypto Market Screening</p>
                </div>
                        ...
                        <div className="flex items-start justify-between mb-3">
                            <div>
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-gray-400 text-sm">{signal.name}</span>
