...
_ALPHA_ENDPOINT_BLUEPRINTS: tuple[dict[str, Any], ...] = (
    ...
    {
        'id': 'crash_rebound_gate',
        'priority': 'P1',
        'name': 'Crash/rebound market regime gate',
        'http_method': 'GET/POST',
        'internal_path': '/api/admin/mirofish/market/crash-rebound/latest',
        'mcp_tool': 'get_market_crash_rebound_gate',
        'resource_ids': ['bok_fred_macro_mcp', 'alpha_vantage_mcp'],
        'requirement_ids': ['global_regime'],
        'source_grade': 'S/A/B',
        'alpha_impact': 'Detect whether broad-market crash pressure is still active or whether rebound conditions justify relaxing Top 3 confidence caps.',
        'pipeline_position': 'market_context_before_top3_notification',
    },
    {
        'id': 'market_fear_index',
        'priority': 'P1',
        'name': 'Market fear index dashboard endpoint',
        'http_method': 'GET/POST',
        'internal_path': '/api/admin/mirofish/market/fear-index/latest',
        'mcp_tool': 'get_market_fear_index',
        'resource_ids': ['bok_fred_macro_mcp', 'alpha_vantage_mcp'],
        'requirement_ids': ['global_regime'],
        'source_grade': 'A/B',
        'alpha_impact': 'Expose VIX, Fear & Greed, FX, and index stress as transparent risk context for Top 3 confidence caps.',
        'pipeline_position': 'dashboard_market_context_and_confidence_cap',
    },
    {
