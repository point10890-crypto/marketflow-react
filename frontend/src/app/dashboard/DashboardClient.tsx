...
function CompactCard({ href, icon, label, sublabel, accent, status, statusColor, metric, metricLabel, metricSuffix, badge }: CompactCardProps) {
    return (
        <Link
            href={href}
        ...
        <div className="flex flex-col gap-3 md:gap-4 pb-4">
            ...
            <div className="flex items-end justify-between">
                ...
                <div className="hidden md:flex items-center gap-1">
                    {[
                        { label: 'Briefing', href: '/dashboard/us/briefing' },
                        { label: 'VCP', href: '/dashboard/vcp-enhanced' },
                        { label: '종가베팅', href: '/dashboard/kr/closing-bet' },
                    ].map(link => (
            ...
            <div className="flex items-center justify-between pt-1">
                <div className="flex items-center gap-3">
                    <Link href="/dashboard/data-status" className="flex items-center gap-1.5 text-[11px] text-gray-600 hover:text-gray-400 transition-colors">
