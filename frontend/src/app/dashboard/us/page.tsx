...
export default function USMarketDashboard() {
    ...
    const [, setTopPicksData] = useState<TopPicksReportData | null>(null);
    ...
    const loadData = async () => {
        ...
        try {
            const [portfolioRes, , gateRes, perfRes, dsRes, regimeRes, predRes, riskRes, sectorRes, , tpRes] = await Promise.all([
