            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="prose prose-invert prose-sm max-w-none space-y-6 text-gray-400">
                    <section>
                        ...
                        <p>By accessing and using MarketFlow (&quot;the Service&quot;), you agree to be bound by these Terms of Service. If you do not agree, do not use the Service.</p>
                    </section>

                    <section>
                        <h2 className="text-xl font-bold text-white">2. Description of Service</h2>
                        <p>MarketFlow provides market analysis tools, data visualization, and AI-generated insights for educational and informational purposes only. The Service is not a registered investment advisor, broker-dealer, or financial planner.</p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>MarketFlow shall not be liable for any direct, indirect, incidental, or consequential damages arising from your use of the Service, including but not limited to financial losses from investment decisions made based on information provided by the Service.</p>
                    </section>
