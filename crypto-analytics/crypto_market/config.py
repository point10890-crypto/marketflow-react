...
class ScannerCfg:
    ...
    # publish gates
    min_score_4h: int = 40  # Lower threshold to see more signals
    min_score_1d: int = 35
    ...
    tf_4h: TimeframeCfg = TimeframeCfg(
        ...
        breakout_max_pct=15.0,  # Wider range
        min_vol_ratio=0.8,  # Relaxed
        max_wick_ratio=0.80,
        retest_tol_pct=1.0,
...
GRADE_C_PARAMS = {
    ...
    "require_descending_highs": False,
    "require_ascending_lows": False,
    "trend_mode": "ABOVE_EMA200",  # close > EMA200 (longer term uptrend)
}
...
GRADE_D_PARAMS = {
    ...
    "require_descending_highs": False,
    "require_ascending_lows": False,
    "trend_mode": "ANY",  # No trend requirement - accumulation zone detection
}
